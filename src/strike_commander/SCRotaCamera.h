...
//
// Vue ROTA — même formule que CHASE/TARGET (cf. SCOrbitCamera). Une
// instance par RSCameraDef de typeCode RSCAM_ROTA réellement présent dans
// le monde (cf. SCCameraDirector::init()). La matrice d'orbite `orbit` est
// tournée par les entrées joueur (souris/joystick) et la distance `dist`
// est zoomable, au lieu de rester figée à l'identité. ASM
