...
enum prog_op {
    ...
    OP_BRANCH_IF_EQUAL_OR_TRUE = 72,
    OP_BRANCH_IF_NOT_EQUAL_OR_FALSE = 73,
...
static std::unordered_map<prog_op, std::string> prog_op_names = {
    ...
    {OP_BRANCH_IF_EQUAL_OR_TRUE, "OP_BRANCH_IF_EQUAL_OR_TRUE"},
    {OP_BRANCH_IF_NOT_EQUAL_OR_FALSE, "OP_BRANCH_IF_NOT_EQUAL_OR_FALSE"},
