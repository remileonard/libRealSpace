...
TEST_F(ByteStreamTest, ReadFixedFloatBE_ReturnsCorrectValue_AndAdvancesPosition) {
    ...
    EXPECT_FLOAT_EQ(1193047.00f, result); // 1193047 + 255 / 255.0 = 1193048.0
    EXPECT_EQ(4, stream.GetCurrentPosition());
}
